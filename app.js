const cardDetailsArray = [
	...
	},
	{
		...
		quote:
			'"A ship in harbour is safe, but that is not what ships are built for"</br> - Said by John A Shedd', // say annonymous if unknown
		github: 'https://github.com/Endeyr',
		linkedin: 'https://linkedin.com/in/taaron263/',
		email: 'mailto:aaron.thompson42594@gmail.com',
	},
	{
	...
	},
	{
		...
		quote:
			'"The future belongs to those who believe in the beauty of their dreams."</br> - Said by Eleanor Roosevelt', // say annonymous if unknown
	...
	},
	{
		...
		quote:
			'"There is always a better side of everything."</br> - Said by Cank256', // say annonymous if unknown
	...
	},
	{
		...
		quote:
			'"There is freedom waiting for you, on the breezes of the sky, and you ask, what if I fall? Oh my darling, what if you fly?"</br> - Said by Erin Hanson',
	...
	},
	{
		...
		quote:
			'"Do the best you can until you know better. Then when you know better, do better."</br> - Maya Angelou', // say annonymous if unknown
	...
	},
	{
		...
		quote:
			'"The trick is to enjoy life. Do not wish away your days waiting for better ones ahead" - Marjorie Pay Hinkley',
		twitter: 'https://twitter.com',
		dribbble: 'https://dribbble.com',
		behance: 'https://behance.com',
	...
	},
	{
		...
		quote:
			'"When you change your thoughts, remember to also change your world"</br> - Said by Norman Vincent Peale', // say annonymous if unknown
	...
	},
	{
		...
		quote:
			'When you believe so much in something, that thing becomes real. -Mr.Robot', // say annonymous if unknown
	...
	},
	{
		...
		quote:
			'Program testing can be used to show the presence of bugs, but never to show their absence!</br> - Edsger W. Djikstra',
	...
	},
	{
		...
		quote:
			'"Sic parvis magna - (Greatness from small beginnings)"</br> - Sir Francis Drake',
